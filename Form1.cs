...
namespace UsingJavaScriptFunctionInCSharp
{
    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            // her you have to call HTML page using navigate method. Its mandatory to call navigate method when you have to fire web
        ...
        {
            // When the form is loaded the cursor focus on the web browser control
            webBrowser1.Focus();
        ...
        private void Report()
        {
            ...
            // Here I create a simple html content
            StringBuilder sb = new StringBuilder();
            sb.Append("<table>");
            sb.Append("<tr><td><B> Hi this is my report demo</B></td></tr>");
            sb.Append("</table>");

            // Here I have to assign content to the HTML page div which is displayed on the Browser control
            div.InnerHtml = sb.ToString();
        }
        private void PrintReport()
        {
            // I am simply showing print dialoge and call print method of webbrowser control.
